...
export const metadata = {
  ...
  description: "This platform helps travellers discover trusted local transport, train, metro, bus, flight, food, shopping, and map apps by country."
};
    ...
    <>
      <main className="min-h-screen bg-white px-6 py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-8 text-xl leading-9 text-gray-600">This platform helps travellers discover trusted local transport, train, metro, bus, flight, food, shopping, and map apps by country.</p>
