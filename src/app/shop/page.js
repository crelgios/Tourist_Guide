...
export const metadata = {
  ...
  openGraph: {
    ...
    siteName: "Aliwvide",
    title: "Best Travel Accessories & Travel Essentials in India | Aliwvide Shop",
    description: "Browse curated travel bags, gadgets, organizers and flight essentials selected for smarter journeys.",
    images: [{ url: socialImage, width: 1200, height: 630, alt: "Aliwvide Travel Shop" }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Best Travel Accessories & Travel Essentials in India | Aliwvide Shop",
    description: "Curated travel accessories, bags, gadgets, organizers and flight essentials for smarter journeys.",
    images: [socialImage]
  }
};
  ...
  "@graph": [
    {
      ...
      url: pageUrl,
      name: "Aliwvide Travel Shop",
      description: "Curated travel accessories, luggage, gadgets, organizers and travel essentials for travelers in India.",
      isPartOf: {
        "@type": "WebSite",
        name: "Aliwvide",
    ...
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://www.aliwvide.com/" },
        { "@type": "ListItem", position: 2, name: "Travel Shop", item: pageUrl }
      ]
    }
  ]
};
